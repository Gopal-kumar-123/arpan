...
<section class="services-section">
            <div class="container">
               ...
               <p>Trut honesty and integrity. The pillars on which we built. fortresses of happiness, pride and love The building blocks for your lifelong relationship.</p>
               <br>
              <p>"ARPAN VILASH is a mantra of exclusivity, serenity and calm. These exquisite homes are open, perfectly planned fluid spaces designed to enhance the lives of those who inhabit them. The architectural concept re-envisions urban living as a balanced serene sanctuary in the heart of the city's most vibrant and prestigious neighborhoods The Project is situated at PRIME LOCATION of Ranchi City Arpan Colony, Tetartoli Talab, Behind Bariyatu Thana, Near Rims, Ranchi. It is a study in luxurious living for Ranchi People. With limited 2 towers of happiness, ARPAN VILASH gives you an unmatched piece of privacy with detailed luxurious add-ons like party area, Guest Parking and beautiful landscaped gardens with Sufficient Open Space. This is CNT free Project.</p>
         ...
         <section class="services section">
            <div class="container">
               ...
               <ul class="services_list">
                  <li class="services_list-item col-12 col-md-6 col-xxl-4" data-aos="fade-up">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        <span class="number">01</span>
                        <h4 class="title"><a href="#">World Class Amenities</a></h4>
                        <p class="description">
                        We provide exclusive access to top-of-the-line conveniences, including high-class amenities.
                        </p>
                  ...
                  <li class="services_list-item col-12 col-md-6 col-xxl-4" data-aos="fade-up">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        <p class="description">
                        We provide lots of flats, buildings which are affordable for all
                        </p>
                        <a class="link link-arrow" href="#">
                  ...
                  <li class="services_list-item col-12 col-md-6 col-xxl-4" data-aos="fade-up">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        <h4 class="title"><a href="#">Commitment Towards Envirment and Safety</a></h4>
                        <p class="description">
                        We are committed to create a world class environment that is safe and eco-friendly for you and nature
                        </p>
                        <a class="link link-arrow" href="#">
                        Read more						<i class="icon-arrow_right"></i>
                        </a>
                  ...
                  <li class="services_list-item col-12 col-md-6 col-xxl-4" data-aos="fade-up">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        <h4 class="title"><a href="#">Construction Management</a></h4>
                        <p class="description">
                        We always engineers plan, design, monitor and inspect systems to make buildings comfortable, functional, efficient and safe.
                     </p>
                        <a class="link link-arrow" href="#">
                        Read more						<i class="icon-arrow_right"></i>
                        </a>
                  ...
                  <li class="services_list-item col-12 col-md-6 col-xxl-4" data-aos="fade-up">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        <h4 class="title"><a href="#">Qualiy of Engineering</a></h4>
                        <p class="description">
                        We take responsibility for analysis and quantification to ensure that it meets quality and manufacturing standards.
                        </p>
                        <a class="link link-arrow" href="#">
                        Read more					<i class="icon-arrow_right"></i>
                        </a>
                  ...
                  <li class="services_list-item col-12 col-md-6 col-xxl-4" data-aos="fade-up">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        <h4 class="title"><a href="#">Building that Empowers</a></h4>
                        <p class="description">
                        We create buildings that empower your lifestyle and your personality
                        </p>
                        <a class="link link-arrow" href="#">
                        Read more				<i class="icon-arrow_right"></i>
                        </a>
            ...
            <div class="container">
               ...
               <ul class="projects_list row g-0">
                  <li class="projects_list-item col-12 col-md-6" data-order="1">
                     <div class="wrapper d-flex flex-column justify-content-between">
                        <div class="img-wrapper" data-aos="fade-right">
                           <img src="img/Arpan-Enclave.jpg" alt="">
                        </div>
                        <div class="text-wrapper">
                           <h3 class="projects_list-item_title" data-aos="fade-up"><a href="#">
                           Arpan Enclave
                           </a></h3>
                  ...
                  <li class="projects_list-item col-12 col-md-6" data-order="2">
                     <div class="wrapper d-flex flex-column justify-content-between">
                        <div class="img-wrapper" data-aos="fade-right">
                           <img src="img/BHARADWAJ-ARPAN.jpg" alt="">
                        </div>
                        <div class="text-wrapper">
                           <h3 class="projects_list-item_title" data-aos="fade-up"><a href="#">
                           Bharadwaj Arpan 
                  ...
                  <li class="projects_list-item col-12 col-md-6" data-order="3">
                     <div class="wrapper d-flex flex-column justify-content-between">
                        <div class="img-wrapper" data-aos="fade-right">
                           <img src="img/NISHESH-ARPAN.jpg" alt="">
                        </div>
                        <div class="text-wrapper">
                           <h3 class="projects_list-item_title" data-aos="fade-up"><a href="#">
                              Nishesh Arpan
                           ...
                           <div class="projects_list-item_info d-flex flex-wrap align-items-center justify-content-between">
                              ...
                              <span class="location d-flex align-items-center" data-aos="fade-up">
                              <i class="icon-location icon"></i>
                              New Bullet Showroom, Kanke Ranchi
                              </span>
                              <a class="link link-arrow link-arrow--alt" href="#" data-aos="fade-left">
                              See Details
                              <i class="icon-arrow_right"></i>
                  ...
                  <li class="projects_list-item col-12 col-md-6" data-order="4">
                     <div class="wrapper d-flex flex-column justify-content-between">
                        <div class="img-wrapper" data-aos="fade-right">
                        <picture>
                           <img src="img/PALASH-ARPAN.jpg" alt="">
                        </picture>
                        </div>
                        <div class="text-wrapper">
                           <h3 class="projects_list-item_title" data-aos="fade-up"><a href="#">
         ...
         <section class="spots section">
            <div class="container d-flex flex-wrap flex-lg-nowrap">
               <div class="wrapper">
                  ...
                  <div class="spots_map">
                    <img width="700px" src="img/jharkhad.png" alt="">
                  </div>
               </div>
               <div class="spots_info col-lg-6 col-xl-auto">
                  ...
                  <div class="wrapper d-flex flex-column align-items-start justify-content-center justify-content-sm-start">
                     <div class="spots_info-number">
                        <h2 class="countNum number" data-suffix="+" data-value="100">0</h2>
                        <span class="label"> Active Projects in Jharkhand </span>
                     </div>
                     <div class="spots_info-number">
                  ...
                  <a class="spots_info-btn btn" href="#">About company</a>
               </div>
            </div>
         </section>
               ...
               <div class="row g-0">
                  ...
                  <div class="features_card col-12 col-md-6 col-xl-4" data-aos="fade-up" data-order="1">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        We developed unique projects in this developed world of inventions and improved raw resources, we can design and manufacture beautiful structure.
                        </p>
                     </div>
                  </div>
                  <div class="features_card col-12 col-md-6 col-xl-4" data-aos="fade-up" data-aos-delay="50" data-order="2">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        <p class="features_card-description">
                        We believe in creating a comfortable and convenient customized relationship between structure, system, service and management.
                        </p>
                     </div>
                  </div>
                  <div class="features_card col-12 col-md-6 col-xl-4" data-aos="fade-up" data-aos-delay="100" data-order="3">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        <p class="features_card-description">
                        Experience allows us to grow and develop your lifestyle. When you live in our environment, you will learn how to adapt to the circumstances in order to be successful.
                        </p>
                     </div>
                  </div>
                  <div class="features_card col-12 col-md-6 col-xl-4" data-aos="fade-up" data-aos-delay="150" data-order="4">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        <p class="features_card-description">
                        We make great efforts for managerial and technological innovation, and achieve continued success in eco-friendly buildings and intelligent and industrial construction.
                        </p>
                     </div>
                  </div>
                  <div class="features_card col-12 col-md-6 col-xl-4" data-aos="fade-up" data-aos-delay="200" data-order="5">
                     <div class="wrapper d-flex flex-column align-items-start justify-content-between">
                        ...
                        <p class="features_card-description">
                        We take "Development of Happiness Space for Stakeholders" as our mission, and mission, vision, core values. for long term relationships
                        </p>
                     </div>
                  </div>
               </div>
               ...
               <div class="contact_form col-lg-6">
                  ...
                  <div role="form" class="wpcf7" id="wpcf7-f114-o1" lang="en-US" dir="ltr">
                     ...
                     <form action="#" method="post" class="wpcf7-form" novalidate="novalidate">
                        ...
                        <div class="contact_form-form contact-form d-flex flex-wrap justify-content-between" data-type="feedback" >
                           <span class="wpcf7-form-control-wrap your-name"><input type="text" name="your-name" value="" size="40" class="wpcf7-form-control wpcf7-text contact-form_field field required" id="feedbackName" aria-invalid="false" placeholder="Full name" /></span><br />
                           <span class="wpcf7-form-control-wrap your-phone"><input type="text" name="your-phone" value="" size="40" class="wpcf7-form-control wpcf7-text contact-form_field field required" id="feedbackTel" aria-invalid="false" placeholder="Phone" /></span><br />
                           <span class="wpcf7-form-control-wrap your-email"><input type="email" name="your-email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email contact-form_field field required" id="feedbackEmail" aria-required="true" aria-invalid="false" placeholder="Email Address" /></span><br />
                           <span class="wpcf7-form-control-wrap your-message"><textarea name="your-message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea contact-form_field field required" id="feedbackMessage" aria-invalid="false" placeholder="Message"></textarea></span><br />
                           <input type="submit" value="Send message" class="wpcf7-form-control wpcf7-submit contact-form_btn btn" />
                        </div>
               ...
               <div class="contact_info">
                  ...
                  <ul class="contact-info">
                     <li class="contact-info_group">
                        ...
                        <span class="content">98/B1 Emirity Kunj, Harihar Singh Road, Morabadi, Ranchi</span>
                     </li>
                     <li class="contact-info_group">
                        <span class="name">Email</span>
                        <span class="content d-inline-flex flex-column">
                        <a class="link" href="mailto:arpanmega6565@gmail.com">arpanmega6565@gmail.com</a>
                        <a class="link" href="mailto:support@arpanmega6565@gmail.com">support@arpanmega6565@gmail.com</a>
                        </span>
                     </li>
                     <li class="contact-info_group">
                        <span class="name">Phone</span>
                        <span class="content d-inline-flex flex-column">
                        <a class="link" href="tel:+918521456165">+91 8521-456-165</a>
                        <a class="link" href="tel:+919905705709">+91 9905-705-709</a>
                        </span>
                     </li>
                  </ul>
