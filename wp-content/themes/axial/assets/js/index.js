...
;// CONCATENATED MODULE: ./src/js/modules/spots.js


function drawHotspots() {
  var container = document.querySelector('.spots_map');
  ...
  function appendHotSpots() {
    for (var i = 0; i < hotSpots.length; i++) {
      ...
      var speechBubble = document.createElement('span');
  ...
  function positionHotSpots() {
    var spots = document.querySelectorAll('.hot-spot');
    var speechBubbles = document.querySelectorAll('.speech-bubble');
    spots.forEach(function (spot, i) {
      var xPos = hotSpots[i].x,
      yPos = hotSpots[i].y,
      content = hotSpots[i].content;

      spot.style.top = "".concat(yPos, "%");
      spot.style.left = "".concat(xPos, "%");
      speechBubbles[i].textContent = content;
      if (window.innerWidth >= 992) {
        speechBubbles[i].style.top = "".concat(yPos, "%");
        speechBubbles[i].style.left = "".concat(xPos, "%");
      } else {
...
/* harmony default export */ const spots = (drawHotspots);
