...
// EXTERNAL MODULE: ./node_modules/progressbar.js/dist/progressbar.js
var progressbar = __webpack_require__(195);
...
;// CONCATENATED MODULE: ./src/js/modules/progress.js





function initProgressbar() {var container = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.skills';
  var progressBars = document.querySelectorAll('.progressLine');
  var rootEl = document.querySelector(container);
  progressBars.forEach(function (bar) {
    var id = bar.getAttribute('id');
    var value = bar.dataset.value;
    var color = bar.dataset.fill;
    var limit = value / 100;

    var lineBar = new (progressbar_default()).Line("#".concat(id), {
      strokeWidth: 7.5,
      trailWidth: 7.5,
      from: { color: '#f8f8f8' },
      to: { color: color },
      ...
      step: function step(state, shape) {
        shape.path.setAttribute("stroke", state.color);
        shape.setText("".concat(value, "%"));
      } });
...
/* harmony default export */ const progress = (initProgressbar);
