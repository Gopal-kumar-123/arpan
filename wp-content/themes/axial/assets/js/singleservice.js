...
/* harmony default export */ const accordion = (drawAccordion);
...
function isVisible_isVisible(el) {
...
var tiny_slider_tns = function(options) {
  options = extend({
    container: '.slider',
    mode: 'carousel',
    axis: 'horizontal',
...
// === ON RESIZE ===
    ...
    return carousel ?
      function () {
        ...
        if (TRANSITIONDURATION || !speed) {
          ...
          if (!speed || !isVisible_isVisible(container)) { onTransitionEnd(); }
      ...
      function () {
        ...
        if (!TRANSITIONEND || !ANIMATIONEND || !speed || !isVisible_isVisible(container)) { onTransitionEnd(); }
      };
  })();
  ...
  return {
    ...
    destroy: destroy,
    rebuild: function() {
      return tiny_slider_tns(extend(options, optionsElements));
    }
  };
};
...
function initTinySlider(options) {var navSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '.tns-arrows_arrow';
  var slider = tiny_slider_tns(_objectSpread({}, options));
  ...
  var changeNavState = function changeNavState(info) {
  ...
  var test = function test(info) {
    ...
    if (info.container.classList.contains('hero_thumbs')) {
      ...
      containerEl.style.backgroundImage = "url(".concat(slides[info.index].dataset.bg, ")");
    }
  };
...
function initHeroSlider() {
  ...
  var setSlideBg = function setSlideBg(info) {
...
function setBackground(target, srcEl) {
  ...
  targetElems.forEach(function (el, index) {
    el.style.backgroundImage = "url(".concat(slides[index].dataset.bg, ")");
  });
}
;// CONCATENATED MODULE: ./src/js/modules/tabs.js


function drawTabs(selector, trigger) {var content = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.content';
...
/* harmony default export */ const tabs = (drawTabs);
;// CONCATENATED MODULE: ./src/js/modules/steps.js
...
function drawProcessSteps() {
  ...
  function _setTimer() {var delay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 3000;
    var duration = 4500 - delay;
    steps[0].classList.add('is-complete');
    steps.forEach(function (item, i) {
      stepsSpotsUnderlay[i].style.animationDelay = "".concat(delay, "ms");
...
/* harmony default export */ const steps = (drawProcessSteps);
;// CONCATENATED MODULE: ./src/js/singleservice.js
...
document.addEventListener('DOMContentLoaded', function () {
  tabs('.tabs_services', '.tabs_services-triggers_trigger');
  steps();
  initTinySlider({
